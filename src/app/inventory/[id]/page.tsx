...
export default function VehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const formattedPrice = new Intl.NumberFormat("en-US", { style: "currency", currency: "USD", minimumFractionDigits: 0 }).format(vehicle.price);
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}
                ...
                <div className="p-5 bg-[#2A2A2A] rounded-lg border border-[#404040] flex items-center justify-between">
                  ...
                  <p className="font-heading font-bold text-white text-3xl">
                    {new Intl.NumberFormat("en-US", { style: "currency", currency: "USD", minimumFractionDigits: 0 }).format(monthlyPayment)}
              ...
              <div className="sticky top-24 space-y-5">
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}
                  ...
                  <p className="text-[#8F8F93] text-sm mb-6">
                    or from ~{new Intl.NumberFormat("en-US", { style: "currency", currency: "USD", minimumFractionDigits: 0 }).format(monthlyPayment)}/mo
                  </p>
